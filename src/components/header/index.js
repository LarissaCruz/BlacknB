import { DivHeader, LinkLogo, DivOpicao, BtnLocaliza, IconeLocaliza, Texto, BtnLogin,ButtonMenu } from './styles'
import React, { useState } from 'react';
import ModalLocalizacao from '../header/modal'
function Header() {
    ...
    return (
        <DivHeader>
            ...
            <DivOpicao>
                ...
                <BtnLocaliza onClick={() => SetModalLocaliza(true)} >
                    <IconeLocaliza>
                    ...
                    <Texto>Escolher uma localização</Texto>
                </BtnLocaliza>
                {ModalLocaliza ? <ModalLocalizacao onClose={() => SetModalLocaliza(false)} ></ModalLocalizacao> : null}
